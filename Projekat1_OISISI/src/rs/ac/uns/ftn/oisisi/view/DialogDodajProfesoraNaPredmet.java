	...
	public DialogDodajProfesoraNaPredmet(Main_Frame instance, String string, boolean b) {
		...
		potvrda.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				boolean postojiProfesorNaPredmetu = PredmetiController.getInstance().PostojiProfesorNaPredmetu(red,
						licna);
				...
				if (postojiProfesor == true && postojiProfesorNaPredmetu == false && broj == 0) {
					...
					if (!postojiProfesor) {
						...
						setVisible(false);
						JOptionPane.showMessageDialog(null, "Profesor vec postoji na listi tog predmeta kao predavac.",
								"Upozorenje!", JOptionPane.ERROR_MESSAGE);
						setVisible(true);
					} else {
						setVisible(false);
						JOptionPane.showMessageDialog(null, "Nije moguce dodati profesora na predmet.", "Upozorenje!",
