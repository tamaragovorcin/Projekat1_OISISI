...
public class Student extends Osoba implements Serializable {
	...
	public Student(String ime, String prezime, String datumRodjenja, String adresaStanovanja, String kontakt_telefon,
			String email, String brojIndeksa, String datumUpisa, String godinaStudija, String status) {
	...
	public String toString() {
		return super.toString() + " - " + brojIndeksa + " - " + datumUpisa + " - " + godinaStudija + " - " + Status
				+ " - " + predmeti + "\n";
	}
