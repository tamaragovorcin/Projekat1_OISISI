...
public class Profesor extends Osoba implements Serializable {
	...
	public Profesor(String ime, String prezime, String datumRodjenja, String adresaStanovanja, String kontakt_telefon,
			String email, String adresa_kancelarije, String broj_licne_karte, String titula, String zvanje) {
	...
	public String toString() {
		return super.toString() + " - " + adresa_kancelarije + " - " + broj_licne_karte + " - " + titula + " - "
				+ zvanje + " - " + spisak_predmeta + "\n";
	}
}
